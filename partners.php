<?php include 'includes/structure/start.php'; ?>
    ...
    <section class="main-heading" style="background-image: url('library/images/demo-news.jpg');">
        <div class="wrapper-thin">
            <div class="title">
                <h1>Partners</h1>
                <h2>We are absolutely delighted to work with such fantastic partners and sponsors throughout the year to put on this truly unique race in the very heart of the city we love</h2>
            </div>
        </div>
    </section>
    ...
    <section class="partners">
        ...
        <div class="race newyork 2017">
            <div class="race-title">
                <h2>New York 2017</h2>
            </div>
            <div class="race-partners">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam minima numquam eius, est temporibus similique dolore omnis, nemo fugiat, ut vel deleniti odio eum labore delectus culpa neque earum sed?
            </div>
        </div>

        <div class="race newyork 2015">
            <div class="race-title">
                <h2>New York 2015</h2>
            </div>
            <div class="race-partners">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem odio, ex soluta sunt quibusdam porro numquam aut eum est quo consectetur aperiam vitae, tempore consequuntur incidunt nam ad libero reiciendis!
            </div>
        </div>
    </section>
